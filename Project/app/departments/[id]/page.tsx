            ...
            <div className="flex items-center space-x-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-80">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem>New reply to your post</DropdownMenuItem>
                  <DropdownMenuItem>Someone liked your comment</DropdownMenuItem>
                  <DropdownMenuItem>New post in this forum</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
